...
const guides = [
  {
    ...
    items: [
      ...
      "提交预约后先生成待支付订单，完成会员余额支付后确认预约并发放积分。",
    ],
  },
  {
    title: "取消与退款",
  ...
  },
  {
    ...
    items: [
      ...
      "会员中心可以查看余额和积分明细，包含预约扣款退款、商城支付退款和后台调整。",
    ],
  },
  {
    title: "场地使用须知",
  ...
  },
  {
    title: "商城与余额支付",
    items: [
      "商城商品按当前库存购买，支付方式为会员余额支付。",
      "订单支付后会立即扣减库存和会员余额，商品到店领取。",
      "已支付订单可提交退款申请，管理员审核通过后才会退回余额并恢复库存。",
    ],
  },
];
...
const faqs = [
  ...
  ["商城订单如何退款？", "已支付且未完成的商城订单可以在我的商城订单中提交退款申请，管理员审核通过后系统会恢复库存并退回会员余额。"],
